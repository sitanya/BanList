...
CQ::EVEGroupMsg::EVEGroupMsg(int subType, int msgId, long long fromGroup, long long fromQQ, const char *fromAnonymous,
                             const char *msg, int font)
        : EVEMsg(subType, msgId, fromQQ, msg, font), fromGroup(fromGroup), fromAnonymousToken(fromAnonymous),
          fromAnonymousInfo() {}
...
CQ::EVEDiscussMsg::EVEDiscussMsg(int subType, int msgId, long long fromDiscuss, long long fromQQ, const char *msg,
                                 int font)
...
CQ::EVERequestAddFriend::EVERequestAddFriend(int subType, int sendTime, long long fromQQ, const char *msg,
...
CQ::EVERequestAddGroup::EVERequestAddGroup(int subType, int sendTime, long long fromGroup, long long fromQQ,
